...
@Autonomous(name="AutonCloseRed", group="Robot")
        ...
        if (opModeIsActive()) {
            ...
            try {
                ...
                if (new_position == 1) {
                    ...
                    Util.encoderDriveForward(5, motors);
                    Util.servos(leftArm, rightArm, LEFT_ARM_BOTTOM_POSITION + 0.1, RIGHT_ARM_BOTTOM_POSITION - 0.1);
                    Util.encoderDriveLeft(3.5, motors);
                    ...
                    Util.servos(leftArm, rightArm, LEFT_ARM_BOTTOM_POSITION + 0.17, RIGHT_ARM_BOTTOM_POSITION - 0.17);
                    sleep(500);
