...
@Config
@Autonomous(name="AutonFarBlue", group="Robot")
public class AutonFarBlue extends LinearOpMode {
    ...
    public static double LEFT_CLAW_INITIAL_POSITION = 0.21;
    public static double RIGHT_CLAW_INITIAL_POSITION = 0.425;
    public static double CLAW_RETRACT_DIFF = 0.15;
